...
const STEPS = [
  ...
  },
  {
    num: "04",
    title: "Калибровка",
    text: "Еженедельная сверка: что тяжело, что понравилось, что нет. Меняю продукты, упражнения, ставлю напоминания. Чат 24/7 — план подстраивается под тебя, а не наоборот.",
  },
] as const;
